...
<div class="footer">
    <div class="copyright">
        <p>Copyright &copy; BWA Designed by <a href="">Quixlab</a> 2020</p>
    </div>
</div>
<!--**********************************
    Footer end
...
<!-- select2  -->
<script src="{{url('public/assets/plugins/sweetalert/js/sweetalert.min.js')}}"></script>
{{-- <script src="{{url('public/assets/plugins/sweetalert/js/sweetalert.init.js')}}"></script> --}}
<!-- Chartjs -->
